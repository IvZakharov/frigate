    ...
    <section className={styles.hero}>
      <div className={"container h-full relative z-10"}>
        <div className={"flex h-full"}>
          <div
            className={`${styles.content} flex flex-col justify-center h-auto w-96`}
          >
            ...
            <div
              className={
                "md:flex items-center justify-between bg-white rounded-3xl pl-8 whitespace-nowrap"
              }
            >
              <p
                className={"text-sm font-medium leading-4 mb-2.5 md:mb-0 mr-8"}
              >
